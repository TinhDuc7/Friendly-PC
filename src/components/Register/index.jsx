  ...
  return (
    <div className='container-register-page'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='row'>
          <input type="text" name='username' placeholder='Nhập username' value={values.username} onChange={handleChange} onBlur={handleBlur} />
        </div>
        ...
        <div className='row'>
          <input type="email" name='email' placeholder='Nhập email' value={values.email} onChange={handleChange} onBlur={handleBlur} />
        </div>
        {touched.email && !isValid && errors.email && (<p className='red'>{errors.email}</p>)}

        <div className='row'>
          <label>Phone number <strong className='red'>*</strong></label>
        </div>
        <div className='row'>
          <input type="text" name='phone' placeholder='Nhập phone number' value={values.phone} onChange={handleChange} onBlur={handleBlur} />
        </div>
        {touched.phone && !isValid && errors.phone && (<p className='red'>{errors.phone}</p>)}

        <div className='row'>
          <label>Password <strong className='red'>*</strong></label>
        </div>
        <div className='row'>
          <input type="password" name='password' placeholder='Nhập password' value={values.password} onChange={handleChange} onBlur={handleBlur} />
        </div>
