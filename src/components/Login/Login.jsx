      ...
      <MDBRow>
        ...
        <MDBCol col='6' className="mb-5" onSubmit={handleSubmit}>
          <div className="d-flex flex-column ms-5">
            ...
            <MDBInput wrapperClass='mb-4' label='Email address' id='form1' type='email' name="email" value={values.email} onChange={handleChange} onBlur={handleBlur} />
            {touched.email && !isValid && errors.email && <p className="red">{errors.email}</p>}
            <MDBInput wrapperClass='mb-4' label='Password' id='form2' type='password' name="password" value={values.password} onChange={handleChange} onBlur={handleBlur} />
        ...
        <MDBCol col='6' className="mb-5">
          <div className="d-flex flex-column  justify-content-center gradient-custom-2 h-100 mb-4">
            ...
            <div className="text-white px-3 py-4 p-md-5 mx-md-4">
              ...
              <p className="small mb-0">Friendly PC is a sales website specializing in providing high-end technology products such as computers, laptops, computer components, technology accessories, etc. With a team of professional, dedicated staff and long-term experience in the technology field, Friendly PC is committed to providing customers with quality products, competitive prices and excellent after-sales service.
                  
                On Friendly PC, customers can find products of famous brands like Apple, Dell, HP, Asus, Lenovo etc. In addition, Friendly PC also provides reliable warranty and repair services, giving customers peace of mind when using its products.</p> 
